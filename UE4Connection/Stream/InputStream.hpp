...
class UE4CONNECTION_DLLCLASS InputStream : public ByteStream
{
public:
...
public:
    ...
    InputStream& operator>>(SerializeInterface& serialize_object);
    void Read(SerializeInterface& serialize_object);
